...
<head>
    ...
    <title>Add Product - Knit Accessories</title>
            ...
            <form method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-300 focus:border-transparent"></textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="url" id="image_url" name="image_url" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-300 focus:border-transparent"
                        placeholder="https://images.pexels.com/photo-1234567/">
                    <p class="text-sm text-gray-500 mt-1">Use a Pexels image URL for best results</p>
                </div>
